...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210902_cohesion_149418bcae6d58aa6193_20210919161326_archive.zip';
	const ARCHIVE_SIZE		 = '51634214';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '149418b-19161326';
    const SECONDARY_PACKAGE_HASH = '5ecd470-19161326';
	const VERSION			 = '1.4.2';
